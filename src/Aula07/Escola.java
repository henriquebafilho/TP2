...
public class Escola{
	...
	public static void main(String[] args) {
		...
		System.out.println("4 para lista de disciplinas, 5 para lista de aniversários, 6 para remover cadastros ou 7 para editar disciplinas");
		int menu = scan.nextInt(); 
		switch(menu) {
		
		case 1:
			System.out.println("Digite 1 para cadastrar Aluno, 2 para cadastrar Disciplina, 3 para cadastrar Professor ou 4 para voltar.");
			...
			switch(escolhaCadastro){
				...
				case 2:
					...
					Disciplina disciplina = new Disciplina(nomeDisciplina,codigo,ementa,cargaHoraria,lista.retornaProfessor(professorResponsavel));
				...
				case 3:
					...
					Professor professor = new Professor(nome,sobrenome,dia,mes,ano,matriculaProfessor,departamento);
		...
		break;
		case 6:
			System.out.println("Digite 1 para remover aluno, 2 para remover professor, 3 para remover disciplina ou 4 para voltar.");
		...
		case 7:
			...
			lista.mostraDisciplinas();
			String resposta1 = scan.nextLine();
			System.out.println("Digite 'ementa' para alterar a ementa ou 'carga horaria' para alterar a carga horária semanal:");
			String resposta = scan.nextLine();
			if(resposta == "ementa") {
