...
class Aluno extends Pessoa {
    ...
    Aluno(String nome, String sobrenome, int dia, int mes, int ano, String curso, String periodo, String matriculaAluno) {
...
class Professor extends Pessoa {
	...
	Professor(String nome, String sobrenome, int dia, int mes, int ano, String matriculaProfessor, String departamento){
	    super(nome,sobrenome,dia,mes,ano);
